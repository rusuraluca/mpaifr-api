...
class Singletask_Trainer:
    def __init__(self, model, config):
        ...
        self.transforms_train = transforms.Compose([
            transforms.RandomResizedCrop((160, 160), scale=(0.3, 1.0)),
    ...
    def run_epoch(self, loader, training):
        ...
        for i, (images, labels, _, _) in enumerate(loader):
            ...
            if training:
                id_loss, id_accuracy = self.model(images, labels)
                loss = id_loss
    ...
    def run_epoch_leave_one_out(self, loader, training):
        ...
        for i, (images, labels, _, _) in enumerate(loader):
            ...
            wandb.log(metrics)
            if not training:
                sum_accuracy += metrics['Testing/id_accuracy']
